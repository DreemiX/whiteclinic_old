...
class MASB_Lazy_Load {
	...
	public function __construct() {
		...
		// Use the clienticabuilder theme's filter
		add_filter( 'clienticabuilder_custom_footer', array( $this, 'filter_images' ), 100 );
		add_filter( 'clienticabuilder_custom_footer', array( $this, 'filter_iframes' ), 100 );
	...
	public function enqueue_scripts() {
		wp_enqueue_script( 'lazysizes', CBI_MOD_PATH . 'js/lazysizes.min.js', array(), '', true );
	}
