...
jQuery(document).ready(function () {
    ...
    function slRunImgSelectorHandler() {
        ...
        console.log(regular_keys);
        let keys = ['blog-layout', 'blog-sidebar_layout', 'design_layout', 'sidebar_layout', 'shop-layout', 'shop-sidebar_layout'];
    ...
    jQuery('#manage_type_selector_input').on('click', function (e) {
        ...
        let id = jQuery('#clientica-post-layout-settings-box').attr('n');
    ...
    jQuery('#categorydiv').change(function (e) {
        ...
        if (parent && parent.length === 1) {
            ...
            if (jQuery(e.target).is(":checked")) {
                jQuery('div#clientica-post-layout-settings-box').removeClass('unlocked').addClass('locked');
                ...
                jQuery('div#blog_clientica-post-layout-settings-box').removeClass('locked hidden').addClass('unlocked visible');
            }
            else {
                if (active_unblog_cats.length === 0) return;
                jQuery('div#blog_clientica-post-layout-settings-box').removeClass('unlocked').addClass('locked');
                for (i = 0; i < blog_keys.length; i++) {
                    el = jQuery("[name^='" + blog_keys[i] + "']")[0];
                    name = jQuery(el).attr('name');
                    if (name && !name.match(/_locked/)) {
                ...
                jQuery('div#clientica-post-layout-settings-box').removeClass('locked hidden').addClass('unlocked visible');
            }
        }
        else {
    ...
    jQuery('#clientica-post-layout-settings-box').change(function () {
        jQuery('#sealed').attr('value', 0);
    });
    ...
    if (typeof( kc ) === 'object') {
        ...
        jQuery('#clientica-f-post-layout-settings .header_widget').on('change', function (e) {
        ...
        jQuery('#clientica-f-post-layout-settings .footer_widget').on('change', function (e) {
        ...
        jQuery('#clientica-f-post-layout-settings [id$=\'header_type\']').on('change', function (e) {
            let val = Number(jQuery(e.target).val());
            if (val === 1) {
                let slider = jQuery('#clientica-f-post-layout-settings .slider_select');
        ...
        jQuery('#clientica-f-post-layout-settings .slider_select').on('change', function (e) {
        ...
        jQuery('#clientica-f-post-layout-settings input.header_img').on('change', function (e) {
            if (Number(jQuery(e.target).val()) === 0) {
                _$('.headerimage').html('');
            } else {
        ...
        jQuery('#clientica-f-post-layout-settings .content-background-color').on('change', function (e) {
        ...
        jQuery('#clientica-f-post-layout-settings .boxed-background-color').on('change', function (e) {
            let color = jQuery(e.target).val();
            if ('' === color) {
        ...
        jQuery('#clientica-f-post-layout-settings [id$=\'layout\']:not([id$=\'sidebar_layout\'])').on('click', function (e) {
            ...
            if (n === 1) {
                ...
                if (_$('.mainbgr .row').length === 0) {
                    ...
                    _$('.mainbgr').css('background-color', _$('#clientica-f-post-layout-settings #blog-boxed-background-background-color_input').val());
                }
        ...
        jQuery('#clientica-f-post-layout-settings [id$=\'content-background-background-image_input\']').on('change', function (e) {
        ...
        jQuery('#clientica-f-post-layout-settings [id$=\'content-background-background-repeat_select\']').on('change', function (e) {
        ...
        jQuery('#clientica-f-post-layout-settings [id$=\'content-background-background-size_select\']').on('change', function (e) {
            if (jQuery(e.target).val() === 'default') {
        ...
        jQuery('#clientica-f-post-layout-settings [id$=\'content-background-background-attachment_select\']').on('change', function (e) {
            if (jQuery(e.target).val() === 'default') {
        ...
        jQuery('#clientica-f-post-layout-settings [id$=\'content-background-background-position_select\']').on('change', function (e) {
            if (jQuery(e.target).val() === 'default') {
        ...
        jQuery('#clientica-f-post-layout-settings [id$=\'boxed-background-background-image_input\']').on('change', function (e) {
            if (jQuery(e.target).val() === 'none' || jQuery(e.target).val() === '') {
        ...
        jQuery('#clientica-f-post-layout-settings [id$=\'boxed-background-background-repeat_select\']').on('change', function (e) {
            if (jQuery(e.target).val() === 'default') {
        ...
        jQuery('#clientica-f-post-layout-settings [id$=\'boxed-background-background-size_select\']').on('change', function (e) {
            if (jQuery(e.target).val() === 'default') {
        ...
        jQuery('#clientica-f-post-layout-settings [id$=\'boxed-background-background-attachment_select\']').on('change', function (e) {
            if (jQuery(e.target).val() === 'default') {
        ...
        jQuery('#clientica-f-post-layout-settings [id$=\'boxed-background-background-position_select\']').on('change', function (e) {
            if (jQuery(e.target).val() === 'default') {
        ...
        jQuery('#clientica-f-post-layout-settings [id$=\'sidebar_layout\']').on('click', function (e) {
            let n = Number(jQuery(e.target).parent().attr('n'));
            ...
            if (n === 1) {
                ...
                jQuery.post(ajaxurl,
                    {
                        ...
                        s_id: jQuery('#clientica-f-post-layout-settings [name$=\'left_sidebar_widgets\']').val(),
                        nonce: masb_ajax.nonce
                    },
                    function (result) {
                        if (result === -1) {
                ...
                jQuery.post(ajaxurl,
                    {
                        action: 'masb_get_sidebar',
                        s_id: jQuery('#clientica-f-post-layout-settings [name$=\'right_sidebar_widgets\']').val(),
                        nonce: masb_ajax.nonce
                    },
                    function (result) {
                        if (result === -1) {
        ...
        jQuery('#clientica-f-post-layout-settings [id$=\'left_sidebar_widgets\']').on('change', function (e) {
            jQuery.post(ajaxurl,
                {
                    action: 'masb_get_sidebar',
                    s_id: jQuery(e.target).val(),
        ...
        jQuery('#clientica-f-post-layout-settings [id$=\'right_sidebar_widgets\']').on('change', function (e) {
            jQuery.post(ajaxurl,
                {
                    action: 'masb_get_sidebar',
                    s_id: jQuery(e.target).val(),
        ...
        jQuery('#masb-f-save-page-settings').on('click', function (e) {
            ...
            let id = jQuery(e.target).parent().find('#clientica-post-layout-settings-box').attr('n');
        ...
        jQuery('#masb-f-save-composer-box-settings').on('click', function (e) {
            ...
            let id = jQuery(e.target).parent().find('#clientica-post-layout-settings-box').attr('n');
            let data = JSON.stringify(jQuery('#clientica-post-layout-settings-box .composer-block-type-input').serializeMultiArray());
