		...
		public function register_controls( $widget, $args ) {
			...
			$widget->add_control(
				...
				[
					...
					'selectors' => [
						//'{{WRAPPER}} > .elementor-widget-container' => 'margin-right: 2px;',
						'{{WRAPPER}}  .elementor-widget-container::-webkit-scrollbar-thumb' => 'background-color:#babac0;border-radius:16px;',
						'{{WRAPPER}}  .elementor-widget-container::-webkit-scrollbar-track' => '-webkit-box-shadow: inset 0 0 2px rgba(0,0,0,0.3);border-radius:16px;',
					],
				]
			);
			...
			$widget->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .elementor-widget-container' => 'max-height: {{SIZE}}{{UNIT}}; overflow-y: scroll; oveflow-x: hidden;',
					],
				]
			);
			...
			$widget->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .elementor-widget-container::-webkit-scrollbar' => 'width: {{SIZE}}{{UNIT}};',
					],
				]
			);
			...
			$widget->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}}  .elementor-widget-container::-webkit-scrollbar-track' => 'border-style: {{VALUE}};',
					],
				]
			);
			...
			$widget->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}}  .elementor-widget-container::-webkit-scrollbar-track' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$widget->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}}  .elementor-widget-container::-webkit-scrollbar-track' => 'border-color: {{VALUE}};',
					],
				]
			);
			...
			$widget->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}}  .elementor-widget-container::-webkit-scrollbar'       => 'border-radius: {{SIZE}}{{UNIT}};',
						'{{WRAPPER}}  .elementor-widget-container::-webkit-scrollbar-thumb' => 'border-radius: {{SIZE}}{{UNIT}};',
						'{{WRAPPER}}  .elementor-widget-container::-webkit-scrollbar-track' => 'border-radius: {{SIZE}}{{UNIT}};',
					],
				]
			);
			...
			$widget->add_group_control(
				...
				[
					...
					'selector'  => '{{WRAPPER}} .elementor-widget-container::-webkit-scrollbar-thumb',
				]
			);
			...
			$widget->add_group_control(
				...
				[
					...
					'separator' => 'after',
					'selector'  => '{{WRAPPER}}  .elementor-widget-container::-webkit-scrollbar-track',
				]
			);
