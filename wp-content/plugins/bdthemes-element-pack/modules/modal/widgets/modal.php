				...
				'modal' => [
					'data-settings' => [
						wp_json_encode([
							...
							"displayTimes"    => isset($settings['display_times']) ? $settings['display_times'] : null,
							...
							"afterInactivity" => (isset($settings["within_second"])) ? $settings["within_second"]['size'] * 1000 : false,
							"modal_id"        => '#' . $id,
