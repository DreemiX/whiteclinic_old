...
class Post_Grid extends Module_Base {
	...
	public function render_comments() {
		...
		echo 
			'<div class="bdt-post-grid-comments bdt-position-medium bdt-position-bottom-right"><span><i class="ep-icon-bubble" aria-hidden="true"></i> '.get_comments_number().'</span></div>';
	}
